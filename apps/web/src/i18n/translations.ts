...
const da = {
  ...
  "table.pageIntro":
    "Vælg et ledigt bord på planen over Fælledhuset. Tryk på et bord for at se detaljer og reservere det.",
...
const en: Record<TranslationKey, string> = {
  ...
  "table.pageIntro":
    "Pick an available table on the Fælledhuset map. Tap a table to see its details and reserve it.",
