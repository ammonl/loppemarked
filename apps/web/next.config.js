...
// (loppemarked-api.<domain>, fronted by CloudFront) so this build-time-baked
// value does not change when the Lambda Function URL is regenerated. Falls back
// to the local API dev server when unset.
