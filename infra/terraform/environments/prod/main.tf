...
module "loppemarked_stack" {
  ...
  route53_zone_id    = data.terraform_remote_state.dns.outputs.root_zone_id
...
output "route53_zone_id" {
  value = data.terraform_remote_state.dns.outputs.root_zone_id
}

output "route53_nameservers" {
  value = data.terraform_remote_state.dns.outputs.root_nameservers
}
